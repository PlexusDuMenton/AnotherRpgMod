...
namespace AnotherRpgMod.Items
{
    ...
    class ItemSkillTree
    {
        ...
        public void OnShoot(Terraria.DataStructures.IProjectileSource source, Item item, Player Player, ref Vector2 position, ref Vector2 velocity,ref int type, ref int damage, ref float knockBack)
        {
            foreach (ItemNode n in m_nodeList)
            {
