...
namespace AnotherRpgMod.Items
{
    ...
    class ItemNodeAdvanced : ItemNode
    {
        ...
        public virtual void OnShoot(Terraria.DataStructures.IProjectileSource source, Item item, Player Player, ref Vector2 position, ref Vector2 Velocity, ref int type, ref int damage, ref float knockBack)
        {
