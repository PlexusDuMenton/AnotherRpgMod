...
namespace AnotherRpgMod.Items
{
    class AdditionalProjectile : ItemNodeAdvanced
    {
        ...
        public override void OnShoot(Terraria.DataStructures.EntitySource_ItemUse_WithAmmo source,Item item, Player Player, ref Vector2 position, ref Vector2 Velocity, ref int type, ref int damage, ref float knockBack)
        {
